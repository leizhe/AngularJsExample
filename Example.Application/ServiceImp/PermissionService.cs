...
namespace Example.Application.ServiceImp
{
    public class PermissionService : BaseService, IPermissionService
    {
        ...
        public GetResults<PermissionDto> GetPermissions(PageInput input)
        {
            var result = GetDefault<GetResults<PermissionDto>>();
            ...
            result.Data = query.Select(x => new PermissionDto()
            {
                Id = x.Id,
                Name = x.Name
            }).ToList();
        ...
        public UpdateResult UpdatePermission(PermissionDto permissionDto)
        {
        ...
        public CreateResult<int> CreatePermission(PermissionDto permissionDto)
        {

...
using Example.Repository.DBContext;
...
namespace Example.Repository
{
    ...
    {
        private readonly ThreadLocal<ExampleDBContext> _localCtx = new ThreadLocal<ExampleDBContext>(() => new ExampleDBContext());

        public ExampleDBContext DbContext { get { return _localCtx.Value; } }
